...
export default function TabsLayout() {
  ...
  if (role === 'admin') {
    return (
      <Redirect href="/admin/all-users" />
    )
  }

  if (role === 'chef') {
    return (
      <Redirect href="/chefManagement/add-chefs" />
    )
  }
              ...
              {state.routes.map((route) => {
                ...
                const onPress = () => {
                  ...
                  if (route.name === 'Home') {
                    ...
                    if (
                      now -
                        lastHomeTapRef.current <
                        400 &&
                      isFocused
                    ) {
                      // Home is inside the (tabs) route group.
                      router.replace(
                        '/(tabs)/Home' as any
                      )
                    } else if (
