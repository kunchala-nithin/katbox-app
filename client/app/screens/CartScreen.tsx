...
export default function CartScreen() {
  ...
  const loadCouponsForChef = async (targetChefIdOrName: string) => {
    ...
    try {
      const res = await api.get(`/api/chefs/${targetChefIdOrName}/coupons`);
      ...
      console.log("Error loading chef-specific coupons:", e);
      setCoupons([]);
    }
  };
    ...
    try {
      ...
      if (res.data.success && res.data.cart?.length > 0) {
        ...
        const resolvedChefIdentifier =
          ...
          activeCart.chefName ||
          (params.chefId as string) ||
          (params.chefName as string) ||
          "";

        await loadCouponsForChef(resolvedChefIdentifier);
  ...
  const applyCoupon = async (code: string) => {
    const targetChef =
      cartData?.chefId ||
      cartData?.restaurant?._id ||
      cartData?.chefName ||
      (params.chefId as string) ||
      "";

    if (!targetChef) {
      Alert.alert("Error", "No chef assigned to this cart.");
      return;
    }
  ...
  const currentDaySelectionsArray =
    isMealBoxFlow && cartData?.selections ? cartData.selections[previewActiveDay] || [] : [];
  ...
  const handlePlaceOrderNavigation = () => {
    ...
    router.push({
      ...
      params: {
        ...
        appliedCoupon: appliedCoupon || "",
        totalAmount: finalTotal,
        menuName: menu?.name || (isHomemadeFlow ? "Homemade Dishes Order" : "Classic Lunch Plan"),
        menuImage:
          menu?.imageUrl ||
          menu?.heroImageUrl ||
        ...
        scheduledDatesFormatted: orderDetails?.scheduledDatesFormatted
          ...
          : undefined,
        scheduledDatesList: orderDetails?.scheduledDatesList
          ? JSON.stringify(orderDetails.scheduledDatesList)
          : undefined,
        ...
        {isCartLoading ? (
          ...
          isHomemadeFlow ? (
                ...
                cartData.items.map((item: any, idx: number) => (
                  <View
                    ...
                    style={{
                      flexDirection: "row",
                      marginBottom: 16,
                      borderBottomWidth: idx === cartData.items.length - 1 ? 0 : 1,
                  ...
                  >
                    <Image
                      ...
                      style={[styles.itemImage, { width: 75, height: 75, borderRadius: 16 }]}
                    />
                    <View style={{ flex: 1, marginLeft: 16, justifyContent: "center" }}>
                      ...
                      >
                        ...
                        <Text style={[styles.priceValue, { fontSize: 18 }]}>
              ...
              <View style={styles.modernHeaderRow}>
                ...
                <View style={styles.modernTitleBlock}>
                  <Text style={styles.modernMainTitle} numberOfLines={2}>
                    {menu?.name || "Premium Subscription Plan"}
                  </Text>
                  <Text style={styles.modernChefSubtitle}>
                    Chef: {cartData?.chefName || "Expert Chef"}
                  </Text>
                </View>
              </View>
                ...
                <View style={styles.modernInfoGrid}>
                  <View style={styles.modernInfoCell}>
                    ...
                    <Text style={styles.modernCellValue}>
                      {menu?.durationType || "Weekly"} ({cartData?.totalItems || 0} Days)
                    </Text>
                  </View>
                  ...
                  <View style={styles.modernInfoCell}>
                    ...
                    <Text style={styles.modernCellValue}>
                      {orderDetails?.deliveryTimeSlot || "Standard"}
                    </Text>
                  </View>
                </View>
              ...
              <View style={styles.modernStartDateBanner}>
                <Text style={styles.modernStartDateText}>
                  ...
                  <Text style={{ fontWeight: "800", color: "#0B261D" }}>
                    {orderDetails?.deliveryDate || "Scheduled Date"}
                  </Text>
                </Text>
              </View>
            ...
            <View style={styles.mainCardModern}>
              ...
              >
                <Text style={[styles.modernTagTextEdge, { color: "#0F382A" }]}>
                  CATERING PLATTER
                </Text>
              </View>
              ...
              <View style={styles.modernHeaderRow}>
                ...
                <View style={styles.modernTitleBlock}>
                  <Text style={styles.modernMainTitle} numberOfLines={2}>
                    {menu?.name || "Premium Breakfast Box"}
                  </Text>
                  <Text style={styles.modernChefSubtitle}>
              ...
              <View style={styles.groupedMetaSectionContainer}>
                ...
                <View style={styles.modernAddressBlockNested}>
                  ...
                  <View style={{ flex: 1, marginLeft: 8 }}>
                    ...
                    <Text style={styles.modernAddressText} numberOfLines={1}>
                      {orderDetails?.address || "Home Nizampet, Hyderabad"}
                    </Text>
                  </View>
                </View>
              </View>
          ...
          <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptyStateText}>
              Browse your favorite meal plans or platters for your next order
            </Text>
            <TouchableOpacity
        ...
        <View style={styles.premiumSectionCard}>
          <View style={styles.premiumSectionHeaderContainer}>
            <View style={styles.premiumHeaderTitleRow}>
              ...
              <View>
                <Text style={styles.premiumSectionMainHeading}>
                  {cartData?.chefName ? `${cartData.chefName}'s Coupons` : "Chef Offers"}
                </Text>
                <Text style={styles.premiumSectionSubHeading}>
                  Exclusive kitchen discounts from this chef
                </Text>
              </View>
            </View>
          </View>
          ...
          {appliedCoupon ? (
            <View style={styles.daawathAppliedBox}>
              ...
              <View style={{ flex: 1, paddingVertical: 2 }}>
                ...
                <Text style={styles.daawathAppliedSavingsText}>
                  Savings of ₹{discount} activated!
                </Text>
              </View>
              <TouchableOpacity
            ...
            <View style={{ flexDirection: "column" }}>
              <View style={styles.daawathPremiumCouponCard}>
                ...
                <View style={styles.daawathCouponMainBody}>
                  ...
                  <Text style={styles.daawathPremiumCouponDesc}>
                    {coupons[0].type === "FLAT" || coupons[0].type === "flat"
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                    <Ionicons
                      ...
                      style={{ marginRight: 5 }}
                    />
                    <Text style={styles.daawathPremiumCouponMeta}>
                      {coupons[0].description ||
                        `Valid on bookings above ₹${coupons[0].minOrder || 0}`}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              {expandedCoupons && (
                <Animated.View
                  style={{
                    maxHeight: inlineExpansionHeight,
                    opacity: inlineExpansionOpacity,
                    overflow: "hidden",
                  }}
                >
                      ...
                      <View style={styles.daawathCouponMainBody}>
                        ...
                        >
                          ...
                          >
                            <Text
                              style={[
                                styles.daawathPremiumCouponTitle,
                                { color: "#0F382A" },
                              ]}
                            >
                              {coupon.code}
                        ...
                        <Text style={styles.daawathPremiumCouponDesc}>
                          {coupon.type === "FLAT" || coupon.type === "flat"
                        ...
                        <View style={{ flexDirection: "row", alignItems: "center" }}>
                          ...
                          <Text style={styles.daawathPremiumCouponMeta}>
                            {coupon.description ||
                              `Valid on bookings above ₹${coupon.minOrder || 0}`}
                          </Text>
                        </View>
                      </View>
                    </View>
            ...
            >
              <Text style={{ color: "#5B756C", fontSize: 13, fontWeight: "600" }}>
                No coupons currently offered by this chef
              </Text>
            </View>
          )}
          ...
          {coupons.length > 1 && !appliedCoupon && (
            <TouchableOpacity
              style={styles.viewAllOffersLinkRow}
              onPress={toggleInlineCouponsView}
              activeOpacity={0.85}
            >
              <Text style={styles.linkText}>
                {expandedCoupons ? "Collapse coupons" : `View all ${coupons.length} coupons`}
              </Text>
              <Animated.View
                style={[
                  styles.arrowCircleIconBackground,
                  {
                    transform: [
                      {
                        rotate: inlineCouponExpandAnim.interpolate({
                          inputRange: [0, 1],
                          outputRange: ["0deg", "180deg"],
                        }),
                      },
          ...
          <View style={styles.bottomBarRow}>
            <View style={styles.bottomBarPriceBlock}>
              ...
              >
                ...
                <Animated.View
                  style={{ transform: [{ rotate: chevronRotateInterpolate }], marginLeft: 4 }}
                >
                  ...
                  <View style={styles.breakupRow}>
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                      <Ionicons
                        ...
                        style={{ marginRight: 6 }}
                      />
                      <Text style={[styles.breakupLabel, { color: "#0F382A", fontWeight: "700" }]}>
                        Coupon Discount
                      </Text>
                    </View>
        ...
        <Animated.View style={[styles.hurrayOverlay, { opacity: overallOpacity }]}>
          ...
          >
            ...
            <Text style={styles.hurraySubtitle}>
              {cartData?.chefName ? `${cartData.chefName}'s Coupon Applied` : "Coupon Applied"}
            </Text>
            ...
            <Animated.View
              style={[
                ...
                styles.b1,
                {
                  ...
                  transform: [{ translateX: b1X }, { translateY: b1Y }, { scale: bubbleScale }],
                },
              ]}
            />
            <Animated.View
              style={[
                ...
                {
                  opacity: bubbleOpacity,
                  transform: [{ translateX: b2X }, { translateY: b2Y }, { scale: bubbleScale }],
                },
              ]}
            />
            <Animated.View
              style={[
                ...
                {
                  opacity: bubbleOpacity,
                  transform: [{ translateX: b3X }, { translateY: b3Y }, { scale: bubbleScale }],
                },
              ]}
            />
            <Animated.View
              style={[
                ...
                {
                  opacity: bubbleOpacity,
                  transform: [{ translateX: b4X }, { translateY: b4Y }, { scale: bubbleScale }],
                },
              ]}
            />
          </Animated.View>
